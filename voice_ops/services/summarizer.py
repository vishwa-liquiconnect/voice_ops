...
def _generate_issue_payload_with_claude(call_log_info, summary, api_key):
	...
	user_prompt = (
		...
		"  is_actionable: true if the caller is reporting a problem, complaint,\n"
		"    incident, safety concern, or anything needing follow-up. false if\n"
		"    they are just confirming routine status (e.g. 'trip completed\n"
		"    safely'), giving positive feedback with no issues, or leaving an\n"
		"    informational update with nothing to act on.\n"
